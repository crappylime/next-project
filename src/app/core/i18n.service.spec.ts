...
describe('I18nService', () => {
  ...
  describe('extract', () => {
    it('should not modify string', () => {
      expect(extract('Welcome to NextProject !')).toEqual('Welcome to NextProject !');
    });
  });
  ...
  describe('set language', () => {
    ...
    it('should change current language without a region match', () => {
      ...
      // Assert
      expect(translateService.use).toHaveBeenCalledWith('pl-PL');
      expect(onLangChangeSpy).toHaveBeenCalledWith('pl-PL');
    });
